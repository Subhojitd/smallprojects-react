  ...
  return (
    <form onSubmit={handleSubmit}>
      <input
        ...
        className="border-2 border-slate-300 bg-slate-200 rounded-md mr-4 h-12 w-64 px-1 text-black text-xl"
        value={task.taskName}
        onChange={(e) =>
          setTask({
            ...task,
      ...
      />
      <button className="bg-blue-500 rounded-md px-4 h-12 text-white">
        ✏️ Create
      </button>
    </form>
  );
